...
function bj_plugins() {
    ...
    $bj_theme_plugins = array(

        array(
            'name' => 'AL-Manager',
            'slug' => 'al-manager',
            'source' => get_template_directory() . '/plugins/files/al-manager.zip', // The plugin source
            'required' => true,
            'version' => '',
    ...
    $config = array(
        ...
        'strings' => array(
            'page_title' => __('Required/Recomended Theme Plugins', 'basejump'),
